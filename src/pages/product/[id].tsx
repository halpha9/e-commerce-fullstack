  ...
  return (
    <div className="min-h-screen">
      <div className="bg-base-100">
        <div className="sm:py-18 mx-auto py-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="breadcrumbs text-base">
            ...
            >
              <Square2StackIcon className="mr-2 h-4 w-4 stroke-current" />
              <span>Products</span>
            </Link>
          </div>
          {/* Product */}
          <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
              ...
              <div className="mt-10 border-t border-gray-200 pt-10">
                <h3 className="text-sm font-medium text-gray-400">License</h3>
            ...
            <div className="mx-auto mt-16 w-full max-w-2xl lg:col-span-4 lg:mt-0 lg:max-w-none">
              <Tab.Group as="div">
                ...
                <Tab.Panels as={Fragment}>
                    ...
                    {reviews.featured.map((review, reviewIdx) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className="prose-sm prose mt-4 max-w-none text-gray-300"
                  ...
                  <Tab.Panel className="text-sm text-gray-300">
                    <h3 className="sr-only">Frequently Asked Questions</h3>

                    <dl>
                      {faqs.map((faq) => (
                        <Fragment key={faq.question}>
                          <dt className="mt-10 font-medium text-gray-400">
                            {faq.question}
                          </dt>
                          <dd className="prose-sm prose mt-2 max-w-none text-gray-300">
                            <p>{faq.answer}</p>
                          </dd>
                        </Fragment>
                      ))}
                  ...
                  <Tab.Panel className="pt-10">
                    ...
                    <div
                      className="prose-sm prose max-w-none text-gray-300"
