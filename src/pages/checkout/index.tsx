...
export default function Checkout() {
  const { products: basketItems } = useBasket();
    ...
    <div className="p-8 h-full w-screen">
      <main className="lg:flex lg:min-h-full lg:flex-row-reverse lg:overflow-hidden">
        ...
        <section
          ...
          className="hidden w-full max-w-md flex-col shadow rounded-xl lg:flex"
        >
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      name="email-address"
                      autoComplete="email"
                      className="py-1.5 bg-gray-800 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    />
                  </div>
                </div>
