            ...
            <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
              ...
              <form className="mt-2 flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="w-full min-w- bg-base-300 appearance-none rounded-md border border-gray-300 bg-white py-2 px-4 text-base text-gray-300 placeholder-gray-500 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                />
